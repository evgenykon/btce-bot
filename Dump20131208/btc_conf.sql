...
CREATE TABLE `conf` (
  ...
  `stage` enum('Order','ExpectProgress','Progress','ExpectPeak','Peak','') NOT NULL,
  PRIMARY KEY (`idconf`),
...
INSERT INTO `conf` VALUES (1,'btc',0.01,1,''),(2,'rur',300,0,''),(3,'usd',10,0,''),(4,'ppc',1,0,''),(5,'ltc',0.01,0,''),(6,'eur',5,0,''),(7,'nmc',0.01,0,''),(8,'nvc',0.01,0,''),(9,'trc',0.01,0,''),(10,'ftc',0.01,0,''),(11,'xpp',0.01,0,'');
